    ...
    <div id="portrait-container">
      ...
      <div id="portrait-core-container">
        <div id="portrait-title-container">
          <span id="portrait-title">Portraits</span>
        </div>
        <div id="portrait-text-container">
          {isMobile ? (
            ...
            <>
              ...
              <p id="portrait-text2">
                Animals are quite a big part of my portrait work. From pets to
                insects to livestock, they have a completely different essence
                than humans which is refreshing. Their eyes are generally my
                focus, much can be seen through them.
              </p>
            </>
          )}
        </div>
